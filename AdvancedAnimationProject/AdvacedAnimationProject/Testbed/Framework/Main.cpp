		...
		static void Keyboard(unsigned char key, int x, int y){
			...
			switch (key){
				...
				case 'r':
					...
					break;	
				case '3':
					//if (test){ test->LaunchBomb(); }				// Press 3 to launch a bomb.
					break;
				case '4':
					settings.pause = !settings.pause;
					break;	
...
GLUI_Spinner* particleIterationSpinner = glui->add_spinner("Pcl Iters", GLUI_SPINNER_INT, &settings.particleIterations);
